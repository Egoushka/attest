...
namespace Attest.Tests
{
    public class EcuadorValidatorTests
    {
        ...
        // of 6 or below and a Luhn style check digit folded modulo 10.
        ...
        [InlineData("1761485257", true)]    // Third digit 6, which the tipo de cedula digit allows
        [InlineData("1714307104", false)]   // Wrong check digit
        [InlineData("1774307100", false)]   // Third digit 7 with a correct check digit
        ...
        // The classes overlap: a third digit of 6 falls back to the natural RUC when the public
        // check sum fails, and a third digit of 9 is tried as a public RUC first.
        ...
        [InlineData("1769083013001", true)]     // Third digit 6, public check sum fails, valid as a natural RUC
        [InlineData("2492819480001", true)]     // Third digit 9, accepted by the public check sum
