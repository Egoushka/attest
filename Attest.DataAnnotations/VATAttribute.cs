...
namespace Attest.DataAnnotations
{
    ...
    {
        /// <summary>Validates a VAT registration number against <paramref name="countryCode"/>'s rule.</summary>
        ...
        /// <summary>
        /// Defers to <see cref="CountryValidator.ValidateVAT"/>. Null passes, so that whether the
