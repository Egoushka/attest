...
namespace Attest.DataAnnotations
{
    ...
    {
        /// <summary>Validates a postal code against <paramref name="countryCode"/>'s rule.</summary>
        ...
        /// <summary>
        /// Defers to <see cref="CountryValidator.ValidateZIPCode"/>. Null passes, so that whether the
