...
{
    /// <summary>Validates the identifiers and postal codes issued by Cuba.</summary>
    public class CubaValidator : IdValidationAbstract
    {
        /// <summary>Creates a validator for Cuba (CU).</summary>
        ...
        /// <summary>
        /// Cuba has no company identifier rule here, so every value is reported invalid -- which is not a
        ...
        /// <summary>Validates a postal code issued by Cuba.</summary>
